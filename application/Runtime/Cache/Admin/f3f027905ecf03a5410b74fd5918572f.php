            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                      ...
                      <li><a href="/admin.php/Brand/brandlist">品牌列表</a></li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="/admin.php/Brand/brandedit/id/2" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="oldlogo" value="<?php echo ($brandinfo["brand_logo"]); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="brand_name" value="<?php echo ($brandinfo["brand_name"]); ?>"  name="brand_name" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_logo" class="col-sm-2 control-label no-padding-right">品牌图片</label>
                            <div class="col-sm-6">
                                <?php if($brandinfo["brand_logo"] == ''): ?>品牌无logo
                                <?php else: ?>
                                <img src="/<?php echo ($brandinfo["brand_logo"]); ?>" width="100" height="50"/><?php endif; ?>
                                <input  id="brand_logo"  name="brand_logo" type="file" style="float:right; margin:13px 70px;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_url" class="col-sm-2 control-label no-padding-right">品牌网址</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="brand_url"  name="brand_url" value="<?php echo ($brandinfo["brand_url"]); ?>"  type="text">
                            </div>
                        </div>
                        <div class="form-group">
