            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                      ...
                      <li><a href="/admin.php/Type/typelist">商品类型列表</a></li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="/admin.php/Type/typeedit/id/1" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($typeinfo["id"]); ?>">
                        <div class="form-group">
                            <label for="typename" class="col-sm-2 control-label no-padding-right">商品类型名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="typename" placeholder="请输入商品类型名称" value="<?php echo ($typeinfo["typename"]); ?>"  name="typename" type="text">
                            </div>
